...
func TestGetAsset(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:        "kustomize-sops",
			tag:         "v2.3.3",
			asset:       "ksops_2.3.3_Linux_arm64.tar.gz",
			downloadURL: "https://github.com/viaduct-ai/kustomize-sops/releases/download/v2.3.3/ksops_2.3.3_Linux_arm64.tar.gz",
			binaryName:  "ksops",
			goos:        "linux",
			goarch:      "amd64",
		},
		{
			...
			repo:        "kustomize-sops",
			tag:         "v2.3.3",
			asset:       "ksops_2.3.3_Windows_arm64.tar.gz",
			downloadURL: "https://github.com/viaduct-ai/kustomize-sops/releases/download/v2.3.3/ksops_2.3.3_Windows_arm64.tar.gz",
		...
		},
		{
			...
			repo:        "kustomize-sops",
			tag:         "v2.3.3",
			asset:       "ksops_2.3.3_Darwin_arm64.tar.gz",
			downloadURL: "https://github.com/viaduct-ai/kustomize-sops/releases/download/v2.3.3/ksops_2.3.3_Darwin_arm64.tar.gz",
			binaryName:  "ksops",
			goos:        "darwin",
			goarch:      "amd64",
		},
