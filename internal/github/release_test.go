...
func TestFindAssetByPlatform(t *testing.T) {
	tests := []struct {
		...
		// aquasecurity/trivy
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "trivy_0.17.2_Linux-64bit.tar.gz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "trivy_0.17.2_macOS-64bit.tar.gz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "argo-darwin-amd64.gz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "argo-windows-amd64.gz",
		...
		// rgoproj/argo-rollouts
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "kubectl-argo-rollouts-linux-amd64",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "kubectl-argo-rollouts-darwin-amd64",
		...
		// aws/amazon-ec2-instance-selector
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "ec2-instance-selector-linux-amd64",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "ec2-instance-selector-darwin-amd64",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "ec2-instance-selector-windows-amd64",
		...
		// buildpacks/pack
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "pack-v0.19.0-linux.tgz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "pack-v0.19.0-macos.tgz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "pack-v0.19.0-windows.zip",
		...
		// CircleCI-Public/circleci-cli
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "circleci-cli_0.1.8764_linux_amd64.tar.gz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "circleci-cli_0.1.8764_darwin_amd64.tar.gz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "circleci-cli_0.1.8764_windows_amd64.zip",
		...
		// cli/cli
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "gh_1.12.0_linux_amd64.tar.gz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "gh_1.12.0_macOS_amd64.tar.gz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "gh_1.12.0_windows_amd64.zip",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "docker-compose-Darwin-x86_64",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "docker-compose-Windows-x86_64.exe",
		...
		// docker/machine
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "docker-machine-Linux-x86_64",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "docker-machine-Darwin-x86_64",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "docker-machine-Windows-x86_64.exe",
		...
		// fluxcd/flux2
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "flux_0.8.0_linux_amd64.tar.gz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "flux_0.8.0_darwin_amd64.tar.gz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "flux_0.8.0_windows_amd64.zip",
		...
		// goodwithtech/dockle
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "dockle_0.3.1_Linux-64bit.tar.gz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "dockle_0.3.1_macOS-64bit.tar.gz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "dockle_0.3.1_Windows-64bit.zip",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "terraform_0.12.20_darwin_amd64.zip",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "terraform_0.12.20_windows_amd64.zip",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "helm-v3.1.0-darwin-amd64.tar.gz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "helm-v3.1.0-windows-amd64.zip",
		...
		// istio/istio
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "istioctl-1.6.0-linux-amd64.tar.gz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "istioctl-1.6.0-osx.tar.gz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "istioctl-1.6.0-win.zip",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "yq_windows_amd64.exe",
		...
		// open-policy-agent/conftest
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "conftest_0.21.0_Linux_x86_64.tar.gz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "conftest_0.21.0_Darwin_x86_64.tar.gz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "conftest_0.21.0_Windows_x86_64.zip",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "opa_windows_amd64.exe",
		...
		// protocolbuffers/protobuf
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "protoc-3.11.4-linux-x86_64.zip",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "protoc-3.11.4-osx-x86_64.zip",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "protoc-3.11.4-win64.zip",
		...
		// starship/starship
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "starship-x86_64-unknown-linux-gnu.tar.gz",
		...
		// viaduct-ai/kustomize-sops
		{
			...
			goos:        "linux",
			goarch:      "amd64",
			assetName:   "ksops_2.3.3_Linux_x86_64.tar.gz",
		...
		},
		{
			...
			goos:        "darwin",
			goarch:      "amd64",
			assetName:   "ksops_2.3.3_Darwin_x86_64.tar.gz",
		...
		},
		{
			...
			goos:        "windows",
			goarch:      "amd64",
			assetName:   "ksops_2.3.3_Windows_x86_64.tar.gz",
