...
func TestApplicationServiceSearch(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			os:      "windows",
			arch:    "amd64",
			asset:   newAsset(newURL("https://github.com/cli/cli/releases/download/v2.51.0/gh_2.51.0_windows_amd64.zip")),
		},
		{
			repo:    newRepository("cli", "cli"),
			release: newRelease("v2.51.0"),
			os:      "windows",
			arch:    "arm64",
			asset:   newAsset(newURL("https://github.com/cli/cli/releases/download/v2.51.0/gh_2.51.0_windows_arm64.zip")),
		},
		// docker/buildx
		{
		...
		{
			repo:    newRepository("docker", "scan-cli-plugin"),
			release: newRelease("v0.26.0"),
			os:      "darwin",
			arch:    "amd64",
			asset:   newAsset(newURL("https://github.com/docker/scan-cli-plugin/releases/download/v0.26.0/docker-scan_darwin_amd64")),
		},
		{
			repo:    newRepository("docker", "scan-cli-plugin"),
			release: newRelease("v0.26.0"),
			os:      "darwin",
			arch:    "arm64",
			asset:   newAsset(newURL("https://github.com/docker/scan-cli-plugin/releases/download/v0.26.0/docker-scan_darwin_arm64")),
		},
		{
			repo:    newRepository("docker", "scan-cli-plugin"),
			release: newRelease("v0.26.0"),
			os:      "linux",
			arch:    "amd64",
			asset:   newAsset(newURL("https://github.com/docker/scan-cli-plugin/releases/download/v0.26.0/docker-scan_linux_amd64")),
		},
		{
			repo:    newRepository("docker", "scan-cli-plugin"),
			release: newRelease("v0.26.0"),
			os:      "linux",
			arch:    "arm64",
			asset:   newAsset(newURL("https://github.com/docker/scan-cli-plugin/releases/download/v0.26.0/docker-scan_linux_arm64")),
		},
		{
			repo:    newRepository("docker", "scan-cli-plugin"),
			release: newRelease("v0.26.0"),
			os:      "windows",
			arch:    "amd64",
			asset:   newAsset(newURL("https://github.com/docker/scan-cli-plugin/releases/download/v0.26.0/docker-scan_windows_amd64.exe")),
		},
		// fluxcd/flux2
		{
			repo:    newRepository("fluxcd", "flux2"),
			release: newRelease("v2.3.0"),
			os:      "darwin",
			arch:    "amd64",
			asset:   newAsset(newURL("https://github.com/fluxcd/flux2/releases/download/v2.3.0/flux_2.3.0_darwin_amd64.tar.gz")),
		},
		{
			repo:    newRepository("fluxcd", "flux2"),
			release: newRelease("v2.3.0"),
			os:      "darwin",
			arch:    "arm64",
			asset:   newAsset(newURL("https://github.com/fluxcd/flux2/releases/download/v2.3.0/flux_2.3.0_darwin_arm64.tar.gz")),
		},
		{
			repo:    newRepository("fluxcd", "flux2"),
			release: newRelease("v2.3.0"),
			os:      "linux",
			arch:    "amd64",
			asset:   newAsset(newURL("https://github.com/fluxcd/flux2/releases/download/v2.3.0/flux_2.3.0_linux_amd64.tar.gz")),
		},
		{
			repo:    newRepository("fluxcd", "flux2"),
			release: newRelease("v2.3.0"),
			os:      "linux",
			arch:    "arm32",
			asset:   newAsset(newURL("https://github.com/fluxcd/flux2/releases/download/v2.3.0/flux_2.3.0_linux_arm.tar.gz")),
		},
		{
			repo:    newRepository("fluxcd", "flux2"),
			release: newRelease("v2.3.0"),
			os:      "linux",
			arch:    "arm64",
			asset:   newAsset(newURL("https://github.com/fluxcd/flux2/releases/download/v2.3.0/flux_2.3.0_linux_arm64.tar.gz")),
		},
		{
			repo:    newRepository("fluxcd", "flux2"),
			release: newRelease("v2.3.0"),
			os:      "windows",
			arch:    "amd64",
			asset:   newAsset(newURL("https://github.com/fluxcd/flux2/releases/download/v2.3.0/flux_2.3.0_windows_amd64.zip")),
		},
		{
			repo:    newRepository("fluxcd", "flux2"),
			release: newRelease("v2.3.0"),
			os:      "windows",
			arch:    "arm32",
			asset:   newAsset(newURL("https://github.com/fluxcd/flux2/releases/download/v2.3.0/flux_2.3.0_windows_arm.zip")),
		},
		{
			repo:    newRepository("fluxcd", "flux2"),
			release: newRelease("v2.3.0"),
			os:      "windows",
			arch:    "arm64",
			asset:   newAsset(newURL("https://github.com/fluxcd/flux2/releases/download/v2.3.0/flux_2.3.0_windows_arm64.zip")),
		},
		// goodwithtech/dockle
		{
			repo:    newRepository("goodwithtech", "dockle"),
			release: newRelease("v0.4.14"),
			os:      "linux",
			arch:    "386",
			asset:   newAsset(newURL("https://github.com/goodwithtech/dockle/releases/download/v0.4.14/dockle_0.4.14_Linux-386.tar.gz")),
		},
		{
			repo:    newRepository("goodwithtech", "dockle"),
			release: newRelease("v0.4.14"),
			os:      "linux",
			arch:    "amd64",
			asset:   newAsset(newURL("https://github.com/goodwithtech/dockle/releases/download/v0.4.14/dockle_0.4.14_Linux-64bit.tar.gz")),
		},
		{
			repo:    newRepository("goodwithtech", "dockle"),
			release: newRelease("v0.4.14"),
			os:      "linux",
			arch:    "arm32",
			asset:   newAsset(newURL("https://github.com/goodwithtech/dockle/releases/download/v0.4.14/dockle_0.4.14_Linux-ARM.tar.gz")),
		},
		{
			repo:    newRepository("goodwithtech", "dockle"),
			release: newRelease("v0.4.14"),
			os:      "linux",
			arch:    "arm64",
			asset:   newAsset(newURL("https://github.com/goodwithtech/dockle/releases/download/v0.4.14/dockle_0.4.14_Linux-ARM64.tar.gz")),
		},
		{
			repo:    newRepository("goodwithtech", "dockle"),
			release: newRelease("v0.4.14"),
			os:      "linux",
			arch:    "loong64",
			asset:   newAsset(newURL("https://github.com/goodwithtech/dockle/releases/download/v0.4.14/dockle_0.4.14_Linux-LOONG64.tar.gz")),
		},
		{
			repo:    newRepository("goodwithtech", "dockle"),
			release: newRelease("v0.4.14"),
			os:      "darwin",
			arch:    "amd64",
			asset:   newAsset(newURL("https://github.com/goodwithtech/dockle/releases/download/v0.4.14/dockle_0.4.14_macOS-64bit.tar.gz")),
		},
		{
			repo:    newRepository("goodwithtech", "dockle"),
			release: newRelease("v0.4.14"),
			os:      "darwin",
			arch:    "arm64",
			asset:   newAsset(newURL("https://github.com/goodwithtech/dockle/releases/download/v0.4.14/dockle_0.4.14_macOS-ARM64.tar.gz")),
		},
		// gravitational/teleport
		{
			repo:    newRepository("gravitational", "teleport"),
			release: newRelease("v16.0.1"),
			os:      "linux",
			arch:    "386",
			asset:   newAsset(newURL("https://cdn.teleport.dev/teleport-v16.0.1-linux-386-bin.tar.gz")),
		},
		{
			repo:    newRepository("gravitational", "teleport"),
			release: newRelease("v16.0.1"),
			os:      "linux",
			arch:    "amd64",
			asset:   newAsset(newURL("https://cdn.teleport.dev/teleport-v16.0.1-linux-amd64-bin.tar.gz")),
		},
		{
			repo:    newRepository("gravitational", "teleport"),
			release: newRelease("v16.0.1"),
			os:      "linux",
			arch:    "amd64",
			asset:   newAsset(newURL("https://cdn.teleport.dev/teleport-v16.0.1-linux-amd64-centos7-bin.tar.gz")),
		},
		{
			repo:    newRepository("gravitational", "teleport"),
			release: newRelease("v16.0.1"),
			os:      "linux",
			arch:    "arm64",
			asset:   newAsset(newURL("https://cdn.teleport.dev/teleport-v16.0.1-linux-arm64-bin.tar.gz")),
		},
		{
			repo:    newRepository("gravitational", "teleport"),
			release: newRelease("v16.0.1"),
			os:      "linux",
			arch:    "arm32",
			asset:   newAsset(newURL("https://cdn.teleport.dev/teleport-v16.0.1-linux-arm-bin.tar.gz")),
		},
		{
			repo:    newRepository("gravitational", "teleport"),
			release: newRelease("v16.0.1"),
			os:      "darwin",
			arch:    "amd64",
			asset:   newAsset(newURL("https://cdn.teleport.dev/teleport-v16.0.1-darwin-amd64-bin.tar.gz")),
		},
		{
			repo:    newRepository("gravitational", "teleport"),
			release: newRelease("v16.0.1"),
			os:      "darwin",
			arch:    "arm64",
			asset:   newAsset(newURL("https://cdn.teleport.dev/teleport-v16.0.1-darwin-arm64-bin.tar.gz")),
		},
		{
			repo:    newRepository("gravitational", "teleport"),
			release: newRelease("v16.0.1"),
			os:      "windows",
			arch:    "amd64",
			asset:   newAsset(newURL("https://cdn.teleport.dev/teleport-v16.0.1-windows-amd64-bin.zip")),
		},
		// hashicorp/terraform
		// {
