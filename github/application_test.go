...
func TestFindAndInstallOnLinuxAmd64(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			tag:          "v2.9.18",
			asset:        newAsset(0, "argocd-linux-amd64"),
		...
		},
		{
			...
			tag:          "v1.7.1",
			asset:        newAsset(0, "kubectl-argo-rollouts-linux-amd64"),
		...
		},
		{
			...
			tag:          "v3.5.8",
			asset:        newAsset(0, "argo-linux-amd64.gz"),
		...
		},
		{
			...
			tag:          "v0.34.2",
			asset:        newAsset(0, "pack-v0.34.2-linux.tgz"),
		...
		},
		{
			...
			tag:          "v0.15.1",
			asset:        newAsset(0, "buildx-v0.15.1.linux-amd64"),
		...
		},
		{
			...
			tag:          "v2.28.1",
			asset:        newAsset(0, "docker-compose-linux-x86_64"),
		...
		},
		{
			...
			tag:          "v3.9.0",
			asset:        newAsset(0, "sops-v3.9.0.linux.amd64"),
		...
		},
		{
			...
			tag:          "v0.4.14",
			asset:        newAsset(0, "dockle_0.4.14_Linux-64bit.tar.gz"),
		...
		},
		{
			...
			tag:          "v1.22.2",
			asset:        newAsset(0, "istioctl-1.22.2-linux-amd64.tar.gz"),
		...
		},
		{
			...
			tag:          "v4.44.2",
			asset:        newAsset(0, "yq_linux_amd64.tar.gz"),
		...
		},
		{
			...
			tag:          "v0.53.0",
			asset:        newAsset(0, "conftest_0.53.0_Linux_x86_64.tar.gz"),
		...
		},
		{
			...
			tag:          "v3.16.3",
			asset:        newAsset(0, "gator-v3.16.3-linux-amd64.tar.gz"),
		...
		},
		{
			...
			tag:          "v0.66.0",
			asset:        newAsset(0, "opa_linux_amd64"),
		...
		},
		{
			...
			tag:          "v27.2",
			asset:        newAsset(0, "protoc-27.2-linux-x86_64.zip"),
		...
		},
		{
			...
			tag:          "v1.19.0",
			asset:        newAsset(0, "starship-x86_64-unknown-linux-gnu.tar.gz"),
