...
func TestFindAndInstallOnLinuxAmd64(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			tag:          "v0.53.0",
			asset:        newAsset(176981043, "trivy_0.53.0_Linux-64bit.tar.gz"),
		...
		},
		{
			...
			tag:          "v2.9.18",
			asset:        newAsset(177293568, "argocd-linux-amd64"),
		...
		},
		{
			...
			tag:          "v1.7.1",
			asset:        newAsset(175717897, "kubectl-argo-rollouts-linux-amd64"),
		...
		},
		{
			...
			tag:          "v3.5.8",
			asset:        newAsset(174415137, "argo-linux-amd64.gz"),
		...
		},
		{
			...
			tag:          "v0.34.2",
			asset:        newAsset(172104571, "pack-v0.34.2-linux.tgz"),
		...
		},
		{
			...
			tag:          "v2.52.0",
			asset:        newAsset(175682889, "gh_2.52.0_linux_amd64.tar.gz"),
		...
		},
		{
			...
			tag:          "v0.15.1",
			asset:        newAsset(174531956, "buildx-v0.15.1.linux-amd64"),
		...
		},
		{
			...
			tag:          "v2.28.1",
			asset:        newAsset(175627020, "docker-compose-linux-x86_64"),
		...
		},
		{
			...
			tag:          "v0.4.14",
			asset:        newAsset(149683239, "dockle_0.4.14_Linux-64bit.tar.gz"),
		...
		},
		{
			...
			tag:          "v1.22.2",
			asset:        newAsset(174040551, "istioctl-1.22.2-linux-amd64.tar.gz"),
		...
		},
		{
			...
			tag:          "v4.44.2",
			asset:        newAsset(174040551, "yq_linux_amd64.tar.gz"),
		...
		},
		{
			...
			tag:          "v0.53.0",
			asset:        newAsset(172540735, "conftest_0.53.0_Linux_x86_64.tar.gz"),
		...
		},
		{
			...
			tag:          "v3.16.3",
			asset:        newAsset(169950399, "gator-v3.16.3-linux-amd64.tar.gz"),
		...
		},
		{
			...
			tag:          "v0.66.0",
			asset:        newAsset(176292835, "opa_linux_amd64"),
		...
		},
		{
			...
			tag:          "v27.2",
			asset:        newAsset(175919234, "protoc-27.2-linux-x86_64.zip"),
		...
		},
		{
			...
			tag:          "v1.1292.1",
			asset:        newAsset(176276540, "snyk-linux"),
		...
		},
		{
			...
			tag:          "v1.19.0",
			asset:        newAsset(168103285, "starship-x86_64-unknown-linux-gnu.tar.gz"),
		...
		},
		{
			...
			tag:          "v4.3.2",
			asset:        newAsset(0, "ksops_4.3.2_Linux_x86_64.tar.gz"),
